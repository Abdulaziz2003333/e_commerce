                        ...
                        <div className="w-[870px] ">
                            ...
                            <div className="flex justify-between items-center">
                                <ul>
                                    ...
                                    <li><input
                                        className=" w-[330px] h-[50px] shrink-0 rounded [background:var(--Secondary,#F5F5F5)] pl-3"
                                        placeholder="Md"/></li>
                                </ul>
                                <ul>
                            ...
                            <div>
                                <ul className=" flex justify-end items-center mt-6">
                                    ...
                                    <li>
                                        <button
                                            className=" text-white rounded [background:var(--Button2,#DB4444)] px-12 py-4">Save
                                            Changes
                                        </button>
                                    </li>
                                </ul>
